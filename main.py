...
import sqlalchemy, os, requests, colorama, threading, asyncio, discord, time, AuthGG, getpass, webbrowser, sys, configparser
...
##CONFIG
userconfigss = edit["user_info"]
config_obj = configparser.ConfigParser()
config_obj.read("./data/config.ini")
useinfo = config_obj["user_info"]
userss = useinfo["login"]
passwordss = useinfo["passw"]
##CLONER
...
def mainer():
    ...
    if choice == '1':
        ...
        try:
            client.login(userss, passwordss)
    ...
    if choice == '2':
        ...
        try:
            ...
            print("After logging in once you wont have to again.")
